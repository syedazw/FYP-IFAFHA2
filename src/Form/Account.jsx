...
export default function Account() {
  ...
  function createAccountbyAdmin(event) {
    ...
    let result = firebase.signupUserWithEmailAndPassword(
              ...
              <div className="row">
                <div className="col-sm-5 col-md-12 mx-5">
                  {/* <button type="submit" className="mt-4 me-4 p-2" style={{color: "white", backgroundColor: "#041342" }}>
                                        <Link to="/" className="nav-link" style={{color: "white", backgroundColor: "#041342" }}>LOGIN</Link>
                                    </button> */}
                  <button
                    type="submit"
                    className="mt-4 p-2"
                    style={buttonStyle}
                    onClick={createAccountbyAdmin}
                  >
                    SIGNUP
                  </button>
                  {/* <Outlet /> */}
