        ...
        <div className="row bg-color text-light pt-4">
          ...
          {patdata.length > 0 && (
            <div className="col-sm-12 col-md-2">
              <h6 className="text-center fw-italic">
                Welcome {patdata[0].data.fullname}
              </h6>
            </div>
          )}
          ...
          <div className="col-12 bg-color">
            <nav className="navbar">
              <Link to="#" className="navbar-brand text-light fw-bold mx-5">
                MENU
              </Link>
              <button
              ...
              <div className="collapse navbar-collapse" id="navbarNavDropdown">
                <ul className="navbar-nav">
                  <li className="nav-item">
                    <Link to="/home" className="nav-link text-primary mx-3">
                      HOME
                    </Link>
                  </li>
                  <li className="nav-item">
                  ...
                  <li className="nav-item">
                    <Link to="#" className="nav-link text-light mx-3">
                      UPDATES
                    </Link>
                  </li>
                  <li className="nav-item">
            ...
            >
              <div className="card-body">
                ...
                <ul className="list-unstyled">
                  {patMed.length > 0 &&
                    patMed[0].medications.map((medication, index) => (
                      <li key={index}>
                        <svg
                          ...
                          height="20"
                          fill="currentColor"
                          className="bi bi-capsule mb-2 mx-2"
                          viewBox="0 0 16 16"
                        >
                          <path d="M1.828 8.9 8.9 1.827a4 4 0 1 1 5.657 5.657l-7.07 7.071A4 4 0 1 1 1.827 8.9Zm9.128.771 2.893-2.893a3 3 0 1 0-4.243-4.242L6.713 5.429l4.243 4.242Z" />
                        </svg>
                        {medication.data[0].medicineName} (
                        {medication.data[0].dosage})
                      </li>
                    ))}
                </ul>
              </div>
                ...
                <ul className="list-unstyled">
                  {patRep.length > 0 &&
                    patRep[0].Reports.map((report) => (
                      <li className="bi bi-file-text-fill me-2">
                        {" "}
                        {report.testName}
                      </li>
                    ))}
