      ...
      <div className="container-fluid">
        <div className="row bg-color text-light pt-4">
          ...
          <div className="col-sm-12 col-md-2">
            <p className="text-center">Welcome Mr.Joseph</p>
          </div>
          ...
          <div className="col-12 bg-color">
            <nav className="navbar">
              <Link
                to="/allpatient"
                className="navbar-brand text-light fw-bold mx-5"
              >
                MENU
              </Link>
              <button
              ...
              <div className="collapse navbar-collapse" id="navbarNavDropdown">
                <ul className="navbar-nav">
                  ...
                  <li className="nav-item">
                    <Link to="#" className="nav-link text-primary mx-3">
                      UPDATES
                    </Link>
                  </li>
                  <li className="nav-item">
              ...
              <div className="card-body">
                ...
                <ul className="list-unstyled">
                  <li>
                    <dl>
                      <dt>
                        <i className="bi bi-arrow-right mx-2 mb-2"></i>Term 1:
                      </dt>
                      <dd className="mx-4 fw-light">
                        Description................
                      </dd>
                    </dl>
                  </li>
