        ...
        <div className="row bg-color text-light pt-4">
          ...
          {patdata.length > 0 && (
            <div className="col-sm-12 col-md-2">
              <h6 className="text-center">{patdata[0].data.fullname}</h6>
            </div>
          )}
          ...
          <div className="col-12 bg-color">
            <nav className="navbar">
              <Link to={`/home`} className="navbar-brand text-light fw-bold">
                &lt; BACK
              </Link>
              ...
              <div className="collapse navbar-collapse" id="navbarNavDropdown">
                <ul className="navbar-nav">
                  <li className="nav-item">
                    <Link to="/home" className="nav-link text-light mx-3">
                      HOME
                    </Link>
                  </li>
                  <li className="nav-item">
